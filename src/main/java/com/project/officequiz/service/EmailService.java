...
public class EmailService {
    ...
    public Map<String, Object> fetchEmailHtmlContent(String activationCode) {
    ...
    public void sendEmailUsingTemplate(String recipientEmail,String activationCode) throws MessagingException {
        Map<String, Object> templateModel = fetchEmailHtmlContent(activationCode);
